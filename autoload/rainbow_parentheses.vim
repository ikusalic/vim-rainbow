" extensive modification so that plugin works for multiple buffers
...
function! rainbow_parentheses#Toggle ()
    ...
    " g:rainbow_paren_active -> valute determinates global swhitchin on/off
    
    if !exists('g:rainbow_paren_invoked')
        let g:rainbow_paren_invoked = 1
        let b:rainbow_paren_locally_invoked = 1
    ...
    if !exists('b:rainbow_paren_locally_invoked')
        let b:rainbow_paren_locally_invoked = 1
    ...
    if g:rainbow_paren_active != 0
        call rainbow_parentheses#Clear()
        let g:rainbow_paren_active = 0
    else
        call rainbow_parentheses#Activate()
        let g:rainbow_paren_active = 1
    endif
endfunction
